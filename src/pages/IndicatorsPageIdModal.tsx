...
import { superAdminReview, type IDocument } from "../store/slices/indicatorSlice";
import {
  type IIndicator,
  type ISubmission,
  type IReviewHistory,
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Tabs */}
        <div className="flex px-6 bg-white border-b border-slate-100 gap-6 overflow-x-auto shrink-0">
          {tabs.map((t) => (
            <button
              key={t.key}
